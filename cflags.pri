...
QMAKE_CFLAGS_RELEASE += -std=c++14 -march=native -O3 -pipe
QMAKE_CXXFLAGS_RELEASE += -std=c++14 -march=native -O3 -pipe
QMAKE_CFLAGS_DEBUG += -Werror -std=c++14 -O3 -march=native
QMAKE_CXXFLAGS_DEBUG += -Werror -std=c++14 -O3 -march=native

QMAKE_CFLAGS_RELEASE += -stdlib=libc++
QMAKE_CXXFLAGS_RELEASE += -stdlib=libc++
LIBS += -lc++
